...
export default function MovieReviewsPage() {
  ...
  // Fetch all movie review articles (no pagination on API)
  useEffect(() => {
    setIsLoading(true);
    setError(null);
      ...
      <main className="max-w-4xl mx-auto px-4 py-4">
        ...
        <nav className="mb-2" aria-label="Breadcrumb">
          <ol className="flex flex-wrap items-center text-sm text-gray-500 gap-1">
            ...
            <li className="truncate text-gray-800 font-semibold" aria-current="page">Movie Reviews</li>
          </ol>
        </nav>
        ...
        {isLoading ? (
          <div className="text-center text-gray-500 py-12">Loading movie reviews...</div>
        ) : error ? (
          <div className="text-center text-red-500 py-12">{error}</div>
        ) : (
          <>
            {/* Grid of movie reviews */}
              ...
              {paginatedArticles.map((article) => (
                ...
                >
                  {article.media?.featured_image?.url ? (
                    ...
                    <img
                      src="https://res.cloudinary.com/phonetag/image/upload/v1748045157/default-images/ujxndspocflqkqlkcx1o.png"
                      alt="Default movie review cover"
